...
def objective_function(params):
    ...
    loss = -regressor.score(X_test, y_test)  # Negative R2 score as loss
    return loss
...
from hyperopt import fmin, tpe, SparkTrials, hp
import mlflow
import numpy as np
from sklearn.ensemble import RandomForestRegressor
...
with mlflow.start_run(run_name="best_model"):
    ...
    best_max_features = ['auto', 'sqrt', 'log2'][best_hyperparam["max_features"]]
